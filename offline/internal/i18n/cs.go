...
var csMessages = map[string]string{
	...
	"setupres.next.2":       "V KeePassXC vytvoř novou databázi a jako ochranu zvol <em>Key file</em> = stažený soubor (<strong>do pole Heslo nic nezadávej</strong>).",
...
③  obnova peněženky  →  Bitcoin ₿`,
	...
	"recoverres.next.1": "Otevři svou <code>.kdbx</code> v KeePassXC; jako ochranu zvol <em>Key file</em> = tento soubor (<strong>do pole Heslo nic nezadávej</strong>).",
