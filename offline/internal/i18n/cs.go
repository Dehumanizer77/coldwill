...
③  obnova peněženky  →  Bitcoin ₿`,
	...
	"index.textmap.p": "Ukryj passphrase k peněžence do obyčejného textu: mapa slov do databáze a text jako PDF k vytištění.",

	"tm.title":        "Passphrase v textu",
	"tm.intro":        "Vlož obyčejný text, například článek z novin, a napiš passphrase k peněžence. Každý její znak se stane prvním písmenem nebo číslicí jednoho slova. Dostaneš <strong>mapu</strong>, kde ta slova jsou, a <strong>PDF</strong> s textem k vytištění. Samotný text nic neprozradí a samotná mapa také ne.",
	"tm.lang":         "Jazyk mapy",
	"tm.headline":     "Nadpis (nepovinný, nepočítá se)",
	"tm.text":         "Text",
	"tm.text.p":       "Odstavce odděl prázdným řádkem; v textu bez prázdných řádků bude každý řádek samostatný odstavec. Vyber takový, ve kterém je hodně čísel, aby každou číslicí začínalo nějaké slovo.",
	"tm.passphrase":   "Passphrase k peněžence",
	"tm.passphrase.p": "Jen malá písmena a–z a číslice. Nikam se neukládá a žádná stránka ji už nezobrazí.",
	...
	"tm.res.paras.p":  "Zkontroluj, že jsou to odstavce, které jsi myslel. Přesně tyto jsou v PDF.",
	"tm.res.new":      "nová mapa",

	"tm.map.head":      "Passphrase: poskládej ji z vytištěného textu",
	"tm.map.line":      "%s. znak:  %s. odstavec, %s. slovo",
	...
	"tm.rule.initial":  "z každého slova se bere první písmeno nebo číslice, malým písmenem, bez háčků a čárek („ch“ je c), a znaky se píšou za sebou bez mezer",

	"tm.err.empty":    "Vlož text a napiš passphrase.",
	"tm.err.chars":    "Passphrase smí obsahovat jen malá písmena a–z a číslice a tyto znaky se tak zapsat nedají: %s",
	"tm.err.missing":  "V textu není slovo, které začíná na: %s. Doplň slova nebo čísla, která na ně začínají, nebo vyber jiný text.",
