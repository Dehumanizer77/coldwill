...
var enMessages = map[string]string{
	...
	"setupres.next.2":       "In <a href=\"https://keepassxc.org/download/\">KeePassXC</a> create a new database and choose <em>Key file</em> as the protection, pointing at the downloaded file (<strong>leave the password field empty</strong>).",
...
③  restore the wallet  →  Bitcoin ₿`,
	...
	"recoverres.next.1": "Open your <code>.kdbx</code> in <a href=\"https://keepassxc.org/download/\">KeePassXC</a> and choose <em>Key file</em> as the protection, pointing at this file (<strong>leave the password field empty</strong>).",
