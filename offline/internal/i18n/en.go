...
var enMessages = map[string]string{
	...
	"setupres.next.2":       "In KeePassXC create a new database and choose <em>Key file</em> as the protection, pointing at the downloaded file (<strong>leave the password field empty</strong>).",
...
③  restore the wallet  →  Bitcoin ₿`,
	...
	"recoverres.next.1": "Open your <code>.kdbx</code> in KeePassXC and choose <em>Key file</em> as the protection, pointing at this file (<strong>leave the password field empty</strong>).",
