...
③  obnova peněženky  →  Bitcoin ₿`,
		...
		"rb.step.pc":      "Připrav <strong>počítač odpojený od internetu</strong> (vytáhni kabel, vypni wifi). Je to důležité: slova z částí se do něj budou psát a nesmí se odtud dostat ven.<br>Nástroj <em>inh-offline</em> je na <strong>USB klíči</strong>%s. Na klíči je víc souborů, jeden pro každý typ počítače. <strong>Spusť ten, který sedí:</strong>",
